...
As evidenced by the graph above, this surge in Central American migration is evident in the percentage of citizens of Central Americans countries who are planning to emigrate in the next three years. Notably, in all three countries, the percentage of citizens planning to emigrate has considerably increased since 2012 -- with the percentage of Hondurans planning to make the trip out of the country rising from 12% in 2012 to 40% in 2016. 
...
Even as it appears that Central American migrants specifically are fleeing poverty, they often face significant economic challenges as they try to make it to the United States. Often, in order to secure a safe passage from the Guatemala-Mexico border to the US-Mexico border, these migrants will secure the assistance of 'coyotes,' members of criminal organizations that guide them in their journey. 
